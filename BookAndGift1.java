...
public class BookAndGift1 {
    ...
    private static void createAndShowGUI() {
        ...
        JLabel nameLabel = new JLabel("Book & Gift Shop");
        ...
        // Load the image
        ImageIcon imageIcon = new ImageIcon("images/bk3.png"); // Replace with the actual path to your image
        ...
        informationPanel.add(createInfoLabel("Name: RamKrishna Book Center"));
        informationPanel.add(createInfoLabel("Location: Ganesh Nagar,Nanded"));
        ...
        blockBelowPanel.add(createIconLabela("images/book.jpeg" , "Books"));
        blockBelowPanel.add(createIconLabela("images/compass.jpeg" , "Compass"));
        blockBelowPanel.add(createIconLabela("images/dbook.jpeg" , "Drawing Book"));
        blockBelowPanel.add(createIconLabela("images/dsheet.jpeg" , "Drawing Sheets"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/envlop.jpeg" , "Envlop"));
        blockBelowPanel.add(createIconLabela("images/eraser.jpeg" , "Eraser"));
        blockBelowPanel.add(createIconLabela("images/fevicol.jpeg" , "Fevicol"));
        blockBelowPanel.add(createIconLabela("images/files.jpeg" , "Files"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/notebook.jpeg" , "Notebook"));
        blockBelowPanel.add(createIconLabela("images/pencil.jpeg" , "pencil"));
        blockBelowPanel.add(createIconLabela("images/pens.jpeg" , "pen"));
        blockBelowPanel.add(createIconLabela("images/swapner.jpeg" , "swapner"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/dsheet.jpeg" , "Drawing Sheet"));
        blockBelowPanel.add(createIconLabela("images/files.jpeg" , "Files"));
        blockBelowPanel.add(createIconLabela("images/swapner.jpeg" , "Swapner"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/manyb.jpeg" , "And Many More"));
        blockBelowPanel.add(createIconLabela("images/manys.jpeg" , "And Many More"));
        blockBelowPanel.add(createIconLabela("images/manys.jpeg" , "And Many More"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
