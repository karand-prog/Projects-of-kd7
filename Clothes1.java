...
public class Clothes1 {
    ...
    private static void createAndShowGUI() {
        ...
        JLabel nameLabel = new JLabel("Clothes Shop");
        ...
        // Load the image
        ImageIcon imageIcon = new ImageIcon("images/sp1.png"); // Replace with the actual path to your image
        ...
        informationPanel.add(createInfoLabel("Name: Chintamani Shop"));
        ...
        blockBelowPanel.add(createIconLabela("images/cap.jpeg" , "Cap"));
        blockBelowPanel.add(createIconLabela("images/jacket.jpeg" , "Jacket"));
        blockBelowPanel.add(createIconLabela("images/njac.jpeg" , "Nehru Jacket"));
        ...
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/pants.jpeg" , "Pants"));
        blockBelowPanel.add(createIconLabela("images/npants.jpeg" , "Night Pants"));
        blockBelowPanel.add(createIconLabela("images/shervani.jpeg" , "Shervani"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/shirt.jpeg" , "Shirt"));
        blockBelowPanel.add(createIconLabela("images/socks.jpeg" , "Socks"));
        blockBelowPanel.add(createIconLabela("images/ties.jpeg" , "Ties"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/tshirt.jpeg" , "T-Shirts"));
        blockBelowPanel.add(createIconLabela("images/uniform.jpeg" , "Uniform"));
        blockBelowPanel.add(createIconLabela("images/iner.jpeg" , "InnerWear"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/manyc.jpeg" , "Many More"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
