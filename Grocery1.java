...
public class Grocery1 {
    ...
    private static void createAndShowGUI() {
        ...
        informationPanel.add(createInfoLabel("Name: Chintamani Grocery"));
        ...
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "Cinthol Soap"));
        blockBelowPanel.add(createIconLabela("images/butter.jpeg" , "butter"));
        blockBelowPanel.add(createIconLabela("images/colgate.jpeg" , "colgate"));
        blockBelowPanel.add(createIconLabela("images/flour.jpeg" , "flou"));
        blockBelowPanel.add(createIconLabela("images/grains.jpeg" , "grains"));
        blockBelowPanel.add(createIconLabela("images/ketchup.jpeg" , "ketchup"));
        blockBelowPanel.add(createIconLabela("images/masala.jpeg" , "masala"));
        blockBelowPanel.add(createIconLabela("images/papad.jpeg" , "papad"));
        blockBelowPanel.add(createIconLabela("images/salt.jpeg" , "salt"));
        blockBelowPanel.add(createIconLabela("images/shampoo.jpeg" , "shampoo"));
        blockBelowPanel.add(createIconLabela("images/sugar.jpeg" , "sugar"));
        blockBelowPanel.add(createIconLabela("images/tea powder.jpeg" , "tea powder"));
        blockBelowPanel.add(createIconLabela("images/santoor.jpeg" , "Santoor"));
        blockBelowPanel.add(createIconLabela("images/grains.jpeg" , "grains"));
        blockBelowPanel.add(createIconLabela("images/ketchup.jpeg" , "ketchup"));
        blockBelowPanel.add(createIconLabela("images/lifeboy.jpeg" , "LifeBoy Soap"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/sugar.jpeg" , "sugar"));
        blockBelowPanel.add(createIconLabela("images/tea powder.jpeg" , "tea powder"));
        blockBelowPanel.add(createIconLabela("images/dove.jpeg" , "Dove Soap"));
        blockBelowPanel.add(createIconLabela("images/santoor.jpeg" , "santoor Soap"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/manyg.jpeg" , "And Many More"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/cinthol.jpeg" , "ModifiedText"));
