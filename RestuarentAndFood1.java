...
public class RestuarentAndFood1 {
    ...
    private static void createAndShowGUI() {
        ...
        JLabel nameLabel = new JLabel("Restuarent & Food Shop");
        ...
        // Load the image
        ImageIcon imageIcon = new ImageIcon("images/fd1.png"); // Replace with the actual path to your image
        ...
        informationPanel.add(createInfoLabel("Name: Tipsy Bakery"));
        informationPanel.add(createInfoLabel("Location: Bhagya Nagar,Nanded"));
        informationPanel.add(createInfoLabel("Type: Food Shop"));
        ...
        informationPanel.add(createInfoLabel("Time: 9 AM To 10 PM"));
        ...
        blockBelowPanel.add(createIconLabela("images/chicken.jpeg" , "Chicken"));
        blockBelowPanel.add(createIconLabela("images/dokhla.jpeg" , "Dokla"));
        blockBelowPanel.add(createIconLabela("images/egg.jpeg" , "Egg Dish"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/kokan.jpeg" , "Kokan Dish"));
        blockBelowPanel.add(createIconLabela("images/noddles.jpeg" , "Noddles"));
        blockBelowPanel.add(createIconLabela("images/paneer.jpeg" , "Paneer"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/pizza.jpeg" , "Pizza"));
        blockBelowPanel.add(createIconLabela("images/poha.jpeg" , "Poha"));
        blockBelowPanel.add(createIconLabela("images/samosa.jpeg" , "Samosa"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/south.jpeg" , "South Dish"));
        blockBelowPanel.add(createIconLabela("images/thali.jpeg" , "Thali"));
        blockBelowPanel.add(createIconLabela("images/vadapav.jpeg" , "Vadapav"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("Icon" , "ModifiedText"));
        blockBelowPanel.add(createIconLabela("images/manyr.jpeg" , "And Many More"));
